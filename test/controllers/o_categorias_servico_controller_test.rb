...
class OCategoriasServicoControllerTest < ActionDispatch::IntegrationTest
  setup do
    @o_categoria_servico = o_categorias_servico(:one)
  end

  test "should get index" do
    get o_categorias_servico_url
  ...
  test "should create o_categoria_servico" do
    assert_difference("OCategoriaServico.count") do
      post o_categorias_servico_url, params: { o_categoria_servico: { descricao: @o_categoria_servico.descricao } }
    end
  ...
  test "should destroy o_categoria_servico" do
    ...
    assert_redirected_to o_categorias_servico_url
  end
end
