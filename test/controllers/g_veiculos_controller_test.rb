...
class GVeiculosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create g_veiculo" do
    assert_difference("GVeiculo.count") do
      post g_veiculos_url, params: { g_veiculo: { ano: @g_veiculo.ano, atualizado_em: @g_veiculo.atualizado_em, cor: @g_veiculo.cor, criado_em: @g_veiculo.criado_em, g_centro_custo_id: @g_veiculo.g_centro_custo_id, g_tipo_veiculo_id: @g_veiculo.g_tipo_veiculo_id, km_atual: @g_veiculo.km_atual, marca: @g_veiculo.marca, modelo: @g_veiculo.modelo, placa: @g_veiculo.placa, status_id: @g_veiculo.status_id } }
    end
