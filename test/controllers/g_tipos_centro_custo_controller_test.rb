...
class GTiposCentroCustoControllerTest < ActionDispatch::IntegrationTest
  setup do
    @g_tipo_centro_custo = g_tipos_centro_custo(:one)
  end

  test "should get index" do
    get g_tipos_centro_custo_url
  ...
  test "should create g_tipo_centro_custo" do
    assert_difference("GTipoCentroCusto.count") do
      post g_tipos_centro_custo_url, params: { g_tipo_centro_custo: { descricao: @g_tipo_centro_custo.descricao } }
    end
  ...
  test "should destroy g_tipo_centro_custo" do
    ...
    assert_redirected_to g_tipos_centro_custo_url
  end
end
