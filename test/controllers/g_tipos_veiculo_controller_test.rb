...
class GTiposVeiculoControllerTest < ActionDispatch::IntegrationTest
  setup do
    @g_tipo_veiculo = g_tipos_veiculo(:one)
  end

  test "should get index" do
    get g_tipos_veiculo_url
  ...
  test "should create g_tipo_veiculo" do
    assert_difference("GTipoVeiculo.count") do
      post g_tipos_veiculo_url, params: { g_tipo_veiculo: { descricao: @g_tipo_veiculo.descricao } }
    end
  ...
  test "should destroy g_tipo_veiculo" do
    ...
    assert_redirected_to g_tipos_veiculo_url
  end
end
