...
class OTiposSolicitacaoControllerTest < ActionDispatch::IntegrationTest
  setup do
    @o_tipo_solicitacao = o_tipos_solicitacao(:one)
  end

  test "should get index" do
    get o_tipos_solicitacao_url
  ...
  test "should create o_tipo_solicitacao" do
    assert_difference("OTipoSolicitacao.count") do
      post o_tipos_solicitacao_url, params: { o_tipo_solicitacao: { descricao: @o_tipo_solicitacao.descricao } }
    end
  ...
  test "should destroy o_tipo_solicitacao" do
    ...
    assert_redirected_to o_tipos_solicitacao_url
  end
end
