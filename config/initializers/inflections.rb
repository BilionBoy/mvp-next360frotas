...
ActiveSupport::Inflector.inflections(:en) do |inflect|
  ...
  inflect.irregular 'g_cartao_veiculo', 'g_cartao_veiculos'
  inflect.irregular 'o_status_aprovacao', 'o_status_aprovacao'
  inflect.irregular 'o_status', 'o_status'
  inflect.irregular 'o_orcamento', 'o_orcamentos'
  inflect.irregular 'o_orcamento_proposta', 'o_orcamentos'
